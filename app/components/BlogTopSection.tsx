...
const BlogTopSection = ({ categories }: BlogTopSectionProps) => {
  ...
  return (
        ...
        <div className="container mx-auto max-sm:mt-4">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between min-h-80">
                <div className="md:flex-1 flex flex-col items-start justify-between gap-4">
            ...
            <div className="bg-muted/50 flex font-serif items-center justify-center w-full overflow-x-auto scrollbar-x-none rounded-lg">
